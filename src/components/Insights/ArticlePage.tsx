    ...
    <div className="article__content">
      ...
      <div className="article__body">
        <div className="article__container">
          <div
            className="article__summary-notice"
            role="note"
            aria-label="Summary notice"
          >
            <p>
              <strong>
                <FaFileAlt aria-hidden="true" /> This is a summary of the full
                white paper.
              </strong>{" "}
              For complete technical details, methodology, results, and
              comprehensive analysis, please download the full PDF document
              above.
            </p>
          </div>
          <div
          ...
          />
          <div
            className="article__full-paper-notice"
            role="complementary"
            aria-label="Complete documentation notice"
          >
            <h3>
              <FaClipboardList aria-hidden="true" /> Complete Technical
              Documentation
            </h3>
            <p>
              The full white paper contains detailed methodology, comprehensive
              results, performance tables, technical specifications, and
              extensive analysis not included in this summary. Download the
            ...
            <p className="article__download-cta">
              <strong>
                Click the "Download PDF" button below to access the complete
                white paper.
              </strong>
            </p>
          </div>
