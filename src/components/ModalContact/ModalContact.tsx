...
const ModalContactComponent = () => {
  ...
  return (
    <div className="modal-contact">
      ...
      {isSuccess ? (
        <div className="modal-contact__success">
          <h3 className="modal-contact__success-title">Thank you for your message!</h3>
          <p className="modal-contact__success-message">We'll get back to you as soon as possible.</p>
        </div>
      ) : (
        <>
